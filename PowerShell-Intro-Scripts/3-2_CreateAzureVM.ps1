...
$pip = New-AzureRmPublicIpAddress -Name 'msftestip' -ResourceGroupName $rgName -Location $locName -AllocationMethod Dynamic -DomainNameLabel 'introvm-sql'
...
Get-AzureRMVM -ResourceGroupName $rgname -Name 'IntroToAzureVM' | Select-Object Name,Location,ResourceGroupName,StatusCode

#Launch remote desktop connection
$cmd = "mstsc /v:'introvm-sql.eastus2.cloudapp.azure.com' /admin /f"
